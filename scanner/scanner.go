...
type Scanner struct {
    ...
    token        types.Object  // Last token returned by split.
...
// as a newly allocated object holding its bytes.
func (s *Scanner) Object() types.Object {
    return s.token
}

// Value returns the most recent token generated by a call to Scan
// as a newly allocated value holding its bytes.
func (s *Scanner) Value() types.Value {
    return value.New(s.token)
}
        ...
        if s.end > s.start || s.err != nil {
            ...
            if token != nil {
                if s.err == nil || advance > 0 {
                    ...
                    s.empties++
                    if s.empties > 100 {
                        panic("Scan: 100 empty tokens without progressing")
                    }
                }
